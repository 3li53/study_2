...
# Set folder path
folder_path <- "data_files/pipes_temperature/run2"
...
start_times <- list(
  SCW = "2025-10-22 05:07",
  BUW = "2025-10-22 05:07",
  BCW = "2025-10-22 05:22",
  BCD = "2025-10-22 05:40",
  SUW = "2025-10-22 05:50",
  SCD = "2025-10-22 05:40",
  SUD = "2025-10-22 05:50",
  BUD = "2025-10-22 05:40"
)

# Define experiment end time
end_time <- as.POSIXct("2025-10-28 05:00", tz = "UTC")
...
CairoSVG("temperature_profiles2.svg", width = 12, height = 8)
