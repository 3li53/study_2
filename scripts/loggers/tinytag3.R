...
# Set folder path
folder_path <- "data_files/pipes_temperature/run3"
...
start_times <- list(
  SCW = "2025-11-02 05:07",
  BUW = "2025-11-02 05:07",
  BCW = "2025-11-02 06:20",
  BCD = "2025-11-02 05:22",
  SUW = "2025-11-02 05:50",
  SCD = "2025-11-02 05:40",
  SUD = "2025-11-02 06:01",
  BUD = "2025-11-02 06:01"
)

# Define experiment end time
end_time <- as.POSIXct("2025-11-08 06:00", tz = "UTC")
...
CairoSVG("temperature_profiles3.svg", width = 12, height = 8)
